...
const project_desc = [
  {
    ...
    img: eegtool,
    desc:
      'An EEG-signal analysis tool with GUI on Matlab. Features such as ' +
  ...
  },
  {
    ...
    img: meerkat,
    desc:
      'A note and file storing and searching app. Deploys automatically ' +
  ...
  },
  {
    ...
    img: gazeanalysislib,
    desc:
      'A Matlab library and script that automates many gaze analyses to ' +
  ...
  },
  {
    ...
    img: integra,
    desc:
      'A full-scale RPG project as part of the team, on Ruby over RPG maker framework ',
